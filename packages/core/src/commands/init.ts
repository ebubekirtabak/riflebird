...
export async function initCommand() {
  ...
  console.log(chalk.white('  1. Run: riflebird aim "your test description"'));
  console.log(chalk.white('  2. Run: riflebird fire\n'));
}
...
export default defineConfig({
  ai: {
    ...
    apiKey: process.env.${answers.aiProvider.toUpperCase()}_API_KEY,
